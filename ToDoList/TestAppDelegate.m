...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions
{
    ...
    TestToDoListTableViewController *controller = (TestToDoListTableViewController *)navigationController.topViewController;
    controller.managedObjectContext = self.managedObjectContext;
    
    /* NSError *error;
    NSManagedObjectContext *context = [self managedObjectContext];
    ToDoList *toDoItem = [NSEntityDescription
                                 insertNewObjectForEntityForName:@"ToDoList"
                                 inManagedObjectContext:context];
    //[toDoItem setValue:@"WTF" forKey:@"itemName"];
    //[toDoItem setValue:[NSNumber numberWithBool:YES] forKey:@"completed"];
    //[toDoItem setValue:[NSDate date] forKey:@"creationDate"];
    toDoItem.itemName = @"WTF";
    ...
    for (ToDoList *toDoItem in fetchedObjects) {
        // NSLog(@"Name: %@", [toDoItem valueForKey:@"itemName"]);
        // NSLog(@"Completed: %@", [toDoItem valueForKey:@"completed"]);
...
- (NSManagedObjectModel *)managedObjectModel
{
    ...
    NSURL *modelURL = [[NSBundle mainBundle] URLForResource:@"ToDoListModel" withExtension:@"momd"];
